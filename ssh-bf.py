...
try:
	import pyfiglet
	banner=pyfiglet.figlet_format("SSH Brute-Force tool")
except:
	print("Failed to detect pyfiglet.\n")
	banner="SSH Brute-Force tool"
...
print("brute force begins shortly")
...
try:
	u_file=args.users.strip();p_file=args.passes.strip();host=args.host.strip();cmd=args.cmd.strip();p=args.port
...
print("hence use the credentials to login into host node\n")



print("By manoj and srinivasan.\n")
client.close()
quit()
